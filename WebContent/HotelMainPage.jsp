...
<body>
    ...
    border-color: #7d3c3c;" class = "navbar navbar-default">
		<div  class = "container-fluid">
			<div class = "navbar-header">
				<a class = "navbar-brand" id="heading" style="color: #f3f3f3; font-family: serif; font-size:20px; text-align:center;">Hotel Online Reservation</a>
			</div>
		</div>
	</nav>	
	<ul id = "menu">
