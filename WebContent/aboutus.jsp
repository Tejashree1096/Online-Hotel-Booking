	...
	<div style="margin-left: 0;" class="container">
		<div class="panel panel-default" style="width:1320px;">
			<div class="panel-body" style="font-family: serif;">
				...
				<p style="position: relative; float: left; width: 1000px; font-size:16px;">Ginger
				...
				<img style="float: right;" src="images/about.jpg" width="250px"
					height="150px" /><br>
				<p style="position: relative; float: left; width: 1000px; font-size:16px;">Explore
				...
				<div
					...
					<center>
						<h4 style="color:##484948;">Standard</h4>
					</center>
					<center>
						<label style="color: #7d7b7b;">Small Size Bed</label> <label style="color: #7d7b7b;">Php.
							2,000.00</label>
					</center>
				</div>
				<div
					...
					<center>
						<h4 style="color:##484948;">Extra Bed</h4>
					</center>
					<center>
						<label style="color: #7d7b7b;">Php. 800.00</label>
					</center>
				</div>
				<div
					style="float: left; margin-left: 40px; width: 300px; height: 300px;">
					...
					<center>
						<h4 style="color:##484948;">Superior</h4>
					</center>
					<center>
						<label style="color: #7d7b7b;">1 Medium Size Bed</label> <label style="color: #7d7b7b;">Php.
							2,400.00 </label>
					</center>
				</div>
				...
				<div
					...
					<center>
						<h4 style="color:##484948;">Super Deluxe</h4>
					</center>
					<center>
						<label style="color: #7d7b7b;">2 Medium Size Bed</label> <label style="color: #7d7b7b;">Php.
							2,800.00 </label>
					</center>
				</div>
				<div
					...
					<center>
						<h4 style="color:##484948;">Jr. Suite</h4>
					</center>
					<center>
						<label style="color: #7d7b7b;">Matrimonial</label> <label style="color: #7d7b7b;">Php.
							3,800.00 </label>
					</center>
				</div>
				<div
					...
					<center>
						<h4 style="color:##484948;">Executive Suite</h4>
					</center>
					<center>
						<label style="color: #7d7b7b;">Matrimonial</label> <label style="color: #7d7b7b;">Php.
							4,000.00 </label>
