		...
		<div class = "panel panel-default" style="width:1320px;">
			<div class = "panel-body">
				...
				<div style = "float:left; width:235px; height:250px; margin-left:20px;">
					<img class="gallery" src = "images/dine/1.jpg" />
				</div>
				<div style = "float:left; width:235px; height:250px; margin-left:20px;">
					<img class="gallery" src = "images/dine/2.jpg" />
				</div>
				<div style = "float:left; width:235px; height:250px; margin-left:20px;">
					<img class="gallery" src = "images/dine/3.jpg" />
				</div> 
				<div style = "float:left; width:235px; height:250px; margin-left:20px;">
					<img class="gallery" src = "images/dine/4.jpg" />
				</div>
				
				<div style = "float:left; width:235px; height:250px; margin-left:20px;">
					<img class="gallery" src = "images/dine/5.jpg" />
				</div>
				<br style = "clear:both;" />
				<br />
				<div style = "float:left; width:235px; height:250px; margin-left:20px;">
					<img class="gallery" src = "images/dine/6.jpg" />
				</div>
				<div style = "float:left; width:235px; height:250px; margin-left:20px;">
					<img class="gallery" src = "images/dine/7.jpg" />
				</div>
				<div style = "float:left; width:235px; height:250px; margin-left:20px;">
					<img class="gallery" src = "images/dine/8.jpg" />
				</div>
				
				<div style = "float:left; width:235px; height:250px; margin-left:20px;">
					<img class="gallery" src = "images/dine/9.jpg" />
				</div>
				<div style = "float:left; width:235px; height:250px; margin-left:20px;">
					<img class="gallery" src = "images/dine/10.jpg" />
				</div>
				<br style = "clear:both;" />
				<br />
				<div style = "float:left; width:235px; height:250px; margin-left:20px;">
					<img class="gallery" src = "images/dine/11.jpg" />
				</div>
				<div style = "float:left; width:235px; height:250px; margin-left:20px;">
					<img class="gallery" src = "images/dine/12.jpg" />
				</div>
			</div>
		</div>
	</div>
